        ...
        <div className="collapse navbar-collapse" id="navbarSupportedContent">
          ...
          <form
            onSubmit={(e) => {
              ...
              push(
                `/admin/search/editors-by-office-name?officeName=${state.editor}`
              );
              setState({ editor: "" });
            }}
          ...
          >
            <input
              onChange={(e) => setState({ editor: e.target.value })}
              value={state.editor}
              className="form-control mr-sm-2 "
              type="search"
              placeholder="Search editors(officename)"
            />
          </form>
          ...
          <div className="btn-group account" role="group">
            ...
            <div className="dropdown-menu" aria-labelledby="btnGroupDrop1">
              ...
              <Link
                ...
                to="#"
                onClick={() => {
                  LOGOUT({ route: "/admin/logout", IS_LOADING, push });
                }}
              >
                <svg
                  aria-hidden="true"
